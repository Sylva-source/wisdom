<template>
  <div class="add">
<div class="top">
 <span @click="hu"> ← 返回 | 添加企业</span> <span>程序员</span>
</div>
...
<script>
import {addqiye,indus,getshangchaun} from '@/api/user'
export default {
  name: 'Add',
  data(){
    return{
    ...
    handleRemove(file, fileList) {
      ...
      qd(formName,formName1) {
        this.$refs[formName].validate((valid) => {
          ...
          if (valid) {
const res=addqiye({...this.ruleForm,...this.ruleForm1})
...
console.log("res",res);
this.ruleForm.businessLicenseId=res.id
this.ruleForm.businessLicenseUrl=res.url
